...
/**
 * Locations assigned to a worker for a given day (0..N). Join table so a day can
 * cover several locations and the geofence/monitoring code can `leftJoinAndSelect`
 * the real Location entities.
 */
@Entity('schedule_locations')
@Index('IDX_schedule_locations_location', ['location_id'])
