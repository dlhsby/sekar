 ...
 * raw pings. location_id/district_id come from the ping's shift; within/outside
    ...
    const result: unknown[] = await this.dataSource.query(
      ...
      INSERT INTO location_daily_summaries
        (user_id, date, total_pings, first_ping_at, last_ping_at,
         avg_latitude, avg_longitude, location_id, district_id, is_backfilled)
      SELECT
        ll.user_id,
        ...
        (ARRAY_AGG(a.district_id ORDER BY ll.logged_at DESC))[1],
        $3
