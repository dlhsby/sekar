...
export class LocationTypesService {
  ...
  async findOne(id: string): Promise<LocationType> {
    ...
    const areaType = await this.locationTypeRepository.findOne({
      where: { id },
    });
  ...
  async create(createAreaTypeDto: CreateLocationTypeDto): Promise<LocationType> {
    ...
    const areaType = this.locationTypeRepository.create(createAreaTypeDto);
    const savedAreaType = await this.locationTypeRepository.save(areaType);
