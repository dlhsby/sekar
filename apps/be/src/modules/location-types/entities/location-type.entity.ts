 ...
 * LocationType Entity
 *
 * Represents the types of locations where workers can be assigned.
...
export class LocationType {
  ...
  @ApiProperty({
    description: 'Unique code for the location type',
    example: 'park',
  ...
  @ApiProperty({
    description: 'Display name for the location type',
    example: 'Park',
  })
  @Column({ length: 50 })
  name: string;
  ...
  @ApiProperty({
    description: 'Detailed description of the location type',
  ...
  @ApiProperty({
    description: 'Timestamp when the location type was created',
  ...
  @ApiProperty({
    description: 'Timestamp when the location type was last updated',
    example: '2026-01-08T10:00:00.000Z',
  })
  @UpdateDateColumn()
  updated_at: Date;
   ...
   * When set, the location type is considered deleted but preserved in database
   */
  @DeleteDateColumn()
  deleted_at?: Date;
