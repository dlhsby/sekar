...
import { LocationPlantStatusService } from './location-plant-status.service';
...
describe('LocationPlantStatusService', () => {
  let service: LocationPlantStatusService;
  ...
  beforeEach(async () => {
    ...
    service = module.get<LocationPlantStatusService>(LocationPlantStatusService);
  ...
  describe('getLocationPlantStatus', () => {
    it('should throw NotFoundException when area does not exist', async () => {
      ...
      await expect(service.getLocationPlantStatus('nonexistent-area')).rejects.toThrow(
        NotFoundException,
      );
    });
    ...
    it('should load area with locationType relation', async () => {
      ...
      await service.getLocationPlantStatus('area-1');
    ...
    it('should return correct response structure', async () => {
      ...
      const result = await service.getLocationPlantStatus('area-1');
  ...
  describe('error handling', () => {
    it('should throw NotFoundException with correct error message', async () => {
      ...
      try {
        await service.getLocationPlantStatus('invalid-id');
    ...
    it('should handle database errors gracefully', async () => {
      ...
      await expect(service.getLocationPlantStatus('area-1')).rejects.toThrow('Database error');
    });
  });
