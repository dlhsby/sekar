...
describe('MonitoringService', () => {
  ...
  describe('getLocationStats', () => {
    ...
    it('should return area statistics', async () => {
      ...
      const result = await service.getLocationStats('area-1');

      expect(result).toHaveProperty('id', 'area-1');
      expect(result).toHaveProperty('name', 'Taman Bungkul');
      expect(result).toHaveProperty('location_type', 'Taman');
      expect(result).toHaveProperty('location_type_category', 'ACTIVE');
  ...
  describe('helper methods - edge cases', () => {
    ...
    it('should handle area without rayon_id in getLocationStats', async () => {
