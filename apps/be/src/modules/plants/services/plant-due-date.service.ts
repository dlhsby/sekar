...
export class PlantDueDateService {
   ...
   * @param areaType — LocationType (reserved for future species×area_type refinement; currently unused)
   ...
   * @param areaType — LocationType entity (or null; reserved for future refinement)
