...
export const SETTINGS_CATALOG: SettingsCatalogEntry[] = [
  ...
  // JSON, now unified here; the cache loaders read these).
  {
    ...
    help: 'Usia lokasi terakhir agar petugas masih dihitung aktif (default 600 dtk / 10 mnt)',
    default: 600,
    min: 10,
    max: 86400,
  },
  ...
  {
    key: 'ratelimit.global_ttl_ms',
    group: 'limits',
    subgroup: 'ratelimit',
    valueType: 'number',
    isSecret: false,
    envKey: 'THROTTLE_TTL',
    label: 'Jendela batas permintaan global (ms)',
    default: 60000,
    min: 1000,
    max: 300000,
  },
  ...
  {
    key: 'auth.login_throttle_ttl_ms',
    group: 'limits',
    subgroup: 'ratelimit',
    valueType: 'number',
    isSecret: false,
    envKey: 'AUTH_LOGIN_THROTTLE_TTL',
    label: 'Jendela throttle login (ms)',
    default: 60000,
    min: 1000,
    max: 300000,
  },
