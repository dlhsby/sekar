...
export class LocationsController {
   ...
   *
   * @param locationType - Optional filter by area type code (park, pedestrian, mini_garden, street)
  ...
  findAll(
    ...
    return this.locationsService.findAll(user, locationType, includeInactiveBool);
  }
  ...
  @ApiParam({ name: 'id', description: 'Location UUID' })
  @ApiResponse({ status: 200, type: LocationBoundaryResponseDto })
  @ApiResponse({ status: 404, description: 'Location not found' })
  getBoundary(@Param('id', ParseUUIDPipe) id: string): Promise<LocationBoundaryResponseDto> {
  ...
  updateBoundary(
    ...
    @Body() dto: UpdateLocationBoundaryDto,
