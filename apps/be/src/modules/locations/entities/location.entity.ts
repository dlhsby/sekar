 ...
 * Each location has a GPS center point and radius defining its boundary.
 */
@Entity('locations')
export class Location {
  ...
  @ApiProperty({
    description: 'Location type ID (foreign key UUID)',
  ...
  @ApiProperty({
    description: 'GPS latitude of location center (-90 to 90)',
    example: -7.2905,
    minimum: -90,
    maximum: 90,
  })
  ...
  @ApiProperty({
    description: 'GPS longitude of location center (-180 to 180)',
    example: 112.7398,
    minimum: -180,
    maximum: 180,
  })
  ...
  // Phase 2 additions
  @ApiProperty({
    description: 'Rayon ID this location belongs to',
  ...
  @ApiProperty({
    description: 'Rayon this location belongs to',
    type: () => Rayon,
    required: false,
  })
  ...
  // Region (Kawasan) parent — ADR-045. Nullable; locations re-parented in the UI.
  @ApiProperty({ description: 'Region (Kawasan) this location belongs to', required: false })
  @Column({ type: 'uuid', nullable: true })
  region_id?: string;
  ...
  @ApiProperty({
    description: 'GeoJSON polygon defining location boundary',
    example: {
      type: 'Polygon',
      coordinates: [
        [
