...
```
satgas1 / 12345678               (field worker, satgas)
korlap_pusat_1 / 12345678        (coordinator)
kepala_rayon_pusat_1 / 12345678  (sector head)
admin_data_pusat_1 / 12345678    (admin)
staff_kecamatan_pusat_1 / 12345678 (external pruning requester)
temp_user / temp_password           (password_must_change=true for flow 05)
satgas_fresh / 12345678          (for onboarding flows 06-07)
```

Phone login also works (e.g., `081200000006/12345678`). Check `specs/deployment/` for seeding details.
