...
export function usePageTitle() {
  ...
  return useCallback((pathname: string): string => {
    const pageTitles: Record<string, string> = {
      ...
      '/reports/reporting': t('pageTitle.reportsReporting'),
      '/database': t('pageTitle.database'),
      ...
      '/analytics/locations': t('pageTitle.analyticsAreas'),
...
export function useBreadcrumbTrail() {
  ...
  return useCallback((pathname: string): string[] => {
    const breadcrumbs: Record<string, string[]> = {
      ...
      '/locations': [t('breadcrumb.data'), t('pageTitle.areas')],
      ...
      '/database': [t('breadcrumb.data'), t('pageTitle.database')],
      '/reports': [t('pageTitle.reports')],
      ...
      '/analytics': [t('pageTitle.analytics')],
      '/analytics/locations': [t('pageTitle.analytics'), t('pageTitle.analyticsAreas')],
