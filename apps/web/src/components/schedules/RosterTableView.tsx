/**
 * Roster table view ("Tabel" tab of the Jadwal page) — the materialized daily
 * roster: date picker, status tracking, and row actions (absence, edit,
 * delete). Extracted unchanged from the former page component when the
 * calendar became the primary view (ADR-047).
 */
