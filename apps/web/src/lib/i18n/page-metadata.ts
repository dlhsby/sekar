...
export const PAGE_METADATA = {
  id: {
    ...
    areas: { title: 'Manajemen Area · SEKAR', description: 'Kelola area dan zona kerja di SEKAR' },
    rayons: { title: 'Manajemen Rayon · SEKAR', description: 'Kelola rayon dan struktur organisasi RTH di SEKAR' },
  ...
  en: {
    ...
    areas: { title: 'Area Management · SEKAR', description: 'Manage areas and work zones in SEKAR' },
    rayons: { title: 'Rayon Management · SEKAR', description: 'Manage rayons and the RTH organizational structure in SEKAR' },
