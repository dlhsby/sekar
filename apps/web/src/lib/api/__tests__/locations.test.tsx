/**
 * Unit Tests: Locations API
 * Tests location CRUD operations, polygon handling, and TanStack Query hooks
 */
...
describe('Locations API', () => {
  ...
  describe('useLocations', () => {
    ...
    it('should fetch areas with location_type_id filter', async () => {
