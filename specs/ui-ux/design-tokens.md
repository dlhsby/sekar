...
All Layer 1 values live in a single JSON file committed at repo root under `specs/ui-ux/tokens.json`. Web and mobile consume **generated** files — editing `globals.css` or `nbTokens.ts` by hand is forbidden from Phase 3 onward.
