...
- To change a token: edit `specs/design-system/tokens.json`, run `npm run tokens:build`, commit generated files.
...
```
Token source (canonical):    specs/design-system/tokens.json
...
// not a page background. See specs/design-system/design-tokens.md for the canonical registry.
...
- Status colors: See history/CHANGELOG.md Section J
...
**Other specs folders:**
- `specs/platforms/mobile/screens.md` - Screen wireframes and layouts
- `specs/platforms/mobile/navigation.md` - Navigation structure
- `specs/platforms/web/pages.md` - Web dashboard pages
