...
**Version:** Neo Brutalism 2.1.1 (Phase 4 rebrand re-baseline v2.1.1 applied May 25, 2026; generated tokens from `specs/design-system/tokens.json` via Phase 3 M1-R sub-phase 3-R2; NBModal/NBToast/NBText via 3-R3)
...
> **Phase 3 update:** Token values (colors, shadows, radii, type scale, motion) now come from **generated** `apps/mobile/src/constants/generated/tokens.ts`, emitted from [`specs/design-system/tokens.json`](../../design-system/tokens.json) by `scripts/build-tokens.ts`. Do **not** edit `nbTokens.ts` by hand — it re-exports from the generated file. New NB primitives introduced in Phase 3: `NBModal`, `NBToast`. See [design-tokens.md](../../design-system/design-tokens.md) and [ADR-036](../../architecture/decisions/ADR-036-design-tokens-single-source.md).
...
Three new mobile NB components ship in Phase 3 M1-R sub-phase 3-R3 to complete the Component Parity Matrix in [`specs/design-system/design-tokens.md`](../../design-system/design-tokens.md). All three consume only generated tokens — no hand-set hex values, font sizes, or shadows.
