...
See [design-tokens.md §PWA Requirements](../../design-system/design-tokens.md) for the manifest JSON, icon sizes, service-worker caching strategy, and push-notification types.
...
Tailwind consumes them as `screens.tablet` / `screens.desktop` (mobile is the default; no explicit breakpoint). See [responsive-design.md](../../design-system/responsive-design.md) for per-page layout rules.
...
- [specs/design-system/design-tokens.md](../../design-system/design-tokens.md) — canonical registry (both platforms)
- [specs/platforms/mobile/design-tokens.md](../mobile/design-tokens.md) — mobile-platform lens
- [specs/design-system/tokens.json](../../design-system/tokens.json) — source of truth
- [specs/design-system/neo-brutalism.md](../../design-system/neo-brutalism.md) — design-language bible
- [specs/design-system/responsive-design.md](../../design-system/responsive-design.md) — breakpoint details
