...
The matrix is implementation detail, not an architectural decision change. Lives at [build history](../../history/CHANGELOG.md) for mobile and [`web.md § D-OFFLINE`](../../history/CHANGELOG.md) for web. Shared `OfflineScreen` component spec at [`mobile.md § A5b`](../../history/CHANGELOG.md).
