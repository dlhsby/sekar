...
const users = {
  ...
  supervisor: { username: 'supervisor1', password: 'supervisor123', role: 'Supervisor' },
  worker1: { username: 'worker1', password: 'worker123', role: 'Worker' },
  worker2: { username: 'worker2', password: 'worker123', role: 'Worker' },
  worker3: { username: 'worker3', password: 'worker123', role: 'Worker' },
};
```
