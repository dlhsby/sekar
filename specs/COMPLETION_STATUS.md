...
6. **Mobile parity** — after web design ack — ⏳ **In Progress** (contract sync complete; monitoring drill-UX + all-feature sweep underway). Day-view is the deliberate default (no week/month switcher); "Jadwal Petugas" supervisor viewer is Phase 6 new feature, not a regression → [`REVAMP-STATUS.md`](REVAMP-STATUS.md).
