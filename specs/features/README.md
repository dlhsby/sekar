...
| [Users & profile](users/README.md) | ✅ | `users`, `user-locations` | User CRUD, profile, location assignment |
...
| [Geography](geography/README.md) | ✅ | `locations`, `location-types`, `rayons`, `kecamatans`, `location-staff-requirements` | Kecamatans & staff-requirements are backend-only |
