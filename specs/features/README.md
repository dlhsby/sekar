...
| [Users & profile](users/README.md) | ✅ 🚧 | `users`, `user-locations`, `rbac` | User CRUD, profile; role-driven scope inputs planned |
...
| [Geography](geography/README.md) | ✅ 🚧 | `locations`, `location-types`, `rayons`, `regions`, `kecamatans`, `location-staff-requirements` | 4-level (Region/Kawasan) + per-level styling planned (ADR-045) |
...
| [Plants](plants/README.md) | ✅ | `plants`, `plant-seeds` | Location-aggregate inventory (seeds UI parked) |
