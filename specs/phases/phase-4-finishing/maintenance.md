# Phase 4: System Maintenance & Operations Guide
...
| Database | PostgreSQL 14, ~31 tables (24 Phase 3 + 7 Phase 4) |
...
2. **Redis Adapter** — WebSocket already uses Redis for pub/sub (Phase 3)
