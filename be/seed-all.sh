...
echo ""
echo "   admin               / password123 [superadmin]"
echo "   korlap1             / password123 [korlap]"
echo "   korlap2             / password123 [korlap]"
echo "   satgas1             / password123 [satgas]"
echo "   satgas2             / password123 [satgas]"
echo "   satgas3             / password123 [satgas]"
echo "   admin_system1       / password123 [admin_system]"
echo "   admin_data1         / password123 [admin_data]"
echo "   top_management1     / password123 [top_management]"
echo "   kepala_rayon_selatan/ password123 [kepala_rayon]"
echo "   kepala_rayon_utara  / password123 [kepala_rayon]"
echo "   korlap_bungkul      / password123 [korlap]"
echo "   linmas1             / password123 [linmas]"
echo "   linmas2             / password123 [linmas]"
echo "   satgas4             / password123 [satgas]"
echo ""
