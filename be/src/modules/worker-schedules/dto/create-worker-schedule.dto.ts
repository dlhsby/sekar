...
/**
 * Data Transfer Object for creating a new worker schedule.
 *
 * Validates incoming request data for worker schedule creation endpoint.
 */
export class CreateWorkerScheduleDto {
  /**
   * User ID (Worker/Linmas) to assign.
   *
   * @example 'a1b2c3d4-e5f6-7890-abcd-ef1234567890'
   */
  @ApiProperty({
    description: 'User ID (Worker/Linmas) to assign',
    example: 'a1b2c3d4-e5f6-7890-abcd-ef1234567890',
  })
  ...
  /**
   * Area ID where the worker will be assigned.
   *
   * @example 'c3d4e5f6-a7b8-9012-cdef-123456789012'
   */
  @ApiProperty({
    description: 'Area ID where the worker will be assigned',
    example: 'c3d4e5f6-a7b8-9012-cdef-123456789012',
  })
