...
export class WorkerSchedulesService {
  private readonly logger = new Logger(WorkerSchedulesService.name);
   ...
   */
  async findOne(id: string): Promise<WorkerSchedule> {
   ...
   */
  async findCurrentByUserId(userId: string): Promise<WorkerSchedule | null> {
   ...
   */
  async findByAreaId(areaId: string, activeOnly: boolean = false): Promise<WorkerSchedule[]> {
   ...
   */
  async findByUserId(userId: string, activeOnly: boolean = false): Promise<WorkerSchedule[]> {
    return this.findAll(undefined, userId, activeOnly);
  }

  /**
   * Create a new worker schedule
   *
   ...
   */
  async create(createDto: CreateWorkerScheduleDto, createdBy: string): Promise<WorkerSchedule> {
   ...
   */
  async update(id: string, updateDto: UpdateWorkerScheduleDto): Promise<WorkerSchedule> {
