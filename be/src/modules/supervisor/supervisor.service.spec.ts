  ...
  describe('getAttendance', () => {
    it('should return attendance report for today', async () => {
      const mockAllWorkers = [
        { id: 'worker-1', username: 'worker1', full_name: 'Worker One', role: UserRole.WORKER, is_active: true },
        { id: 'worker-2', username: 'worker2', full_name: 'Worker Two', role: UserRole.WORKER, is_active: true },
        { id: 'worker-3', username: 'worker3', full_name: 'Worker Three', role: UserRole.WORKER, is_active: true },
      ];
      ...
      mockWorkerAssignmentsRepository.findOne
        .mockResolvedValueOnce(null) // worker-3 no assignment
