...
/**
 * DTO for creating a new aktivitas (work activity report)
 * Phase 2C: Simplified aktivitas submission with auto-detected shift
 */
export class CreateAktivitasDto {
  ...
  @ApiProperty({
    ...
    type: [String],
    example: [
      'https://sekar-bucket.s3.amazonaws.com/reports/photo1.jpg',
      'https://sekar-bucket.s3.amazonaws.com/reports/photo2.jpg',
    ],
  })
  @IsArray()
