...
export function TasksActivityScreen({ navigation, route }: Props): React.JSX.Element {
  ...
  React.useEffect(() => {
    ...
    fetchTasks(1, true);
    // eslint-disable-next-line react-hooks/exhaustive-deps -- fetchTasks is a stable callback defined above
  ...
  React.useEffect(() => {
    ...
    fetchActivities(1, true);
    // eslint-disable-next-line react-hooks/exhaustive-deps -- fetchActivities is a stable callback defined above
